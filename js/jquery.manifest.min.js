 ...
 * http://en.wikipedia.org/wiki/MIT_License
 */
(function(d){d.widget("mf.manifest",{options:{formatDisplay:function(a,b,c){return c?c.html():a},formatRemove:function(){return"X"},formatValue:function(a,b,c,e){return e?e.text():a},marcoPolo:{},onAdd:null,onHighlight:null,onHighlightRemove:null,onRemove:null,onSelect:null,onSelectRemove:null,required:!1,separator:",",valuesName:null},_marcoPoloOptions:function(){var a=this,b=a.options;return{onFocus:function(){b.marcoPolo.onFocus&&b.marcoPolo.onFocus.call(this);a._resizeInput()},onSelect:function(c,
e){b.marcoPolo.onSelect&&b.marcoPolo.onSelect.call(this,c,e);a._add(c,e)},required:b.required}},keys:{BACKSPACE:8,DELETE:46,LEFT:37,RIGHT:39},_create:function(){this.$input=this.element.addClass("mf_input");this.$container=d('<div class="mf_container" />');this.$list=d('<ol class="mf_list" />');this.$measure=this._buildMeasure();this.mpMousedown=this.mousedown=!1;this.originalWidth=this.$input.css("width");this.options.marcoPolo&&this._bindMarcoPolo();this._bindInput()._bindList()._bindContainer()._bindDocument();
this.$input.wrap(this.$container).before(this.$list).after(this.$measure);this._resizeInput()},_setOption:function(a,b){var c=this.$input;switch(a){case "marcoPolo":this.options.marcoPolo?b?c.marcoPolo("option",d.extend({},b,this._marcoPoloOptions())):c.marcoPolo("destroy"):b&&(this._bindMarcoPolo(d.extend({},b,this._marcoPoloOptions())),c.marcoPolo("list").insertAfter(c.parent()));break;case "required":this.options.marcoPolo&&c.marcoPolo("option","required",b);break;case "valuesName":this.$list.find("input:hidden.mf_value").attr("name",
b+"[]")}d.Widget.prototype._setOption.apply(this,arguments)},container:function(){return this.$container},list:function(){return this.$list},_add:function(a,b){var c=this.$input;this.add(a,b);this.options.marcoPolo?c.marcoPolo("change",""):c.val("");this._resizeInput();return this},add:function(a,b){var c=this.$input,e=this.options,f=d('<li class="mf_item" />'),h=d('<a href="#" class="mf_remove" title="Remove" />'),g=d('<input type="hidden" class="mf_value" />'),i=!0;f.data("manifest",a);f.html(e.formatDisplay.call(c,
a,f,b));h.html(e.formatRemove.call(c,h,f));e.valuesName?g.attr("name",e.valuesName+"[]"):g.attr("name",c.attr("name")+"_values[]");g.val(e.formatValue.call(c,a,g,f,b));f.append(h,g);i=this._trigger("add",[a,f]);i!==!1&&f.appendTo(this.$list)},remove:function(a){var b=this,c=d(),c=a instanceof jQuery?a:b.$list.children(a);c.each(function(){var a=d(this),c=!0,c=b._trigger("remove",[a.data("manifest"),a]);c!==!1&&a.remove()})},destroy:function(){this.options.marcoPolo&&this.$input.marcoPolo("destroy");
this.$list.remove();this.$measure.remove();this.$input.unwrap().removeClass("mf_input").width(this.originalWidth);d(document).unbind(".manifest");d.Widget.prototype.destroy.apply(this,arguments)},_trigger:function(a,b){var c="on"+a.charAt(0).toUpperCase()+a.slice(1),e=this.widgetEventPrefix.toLowerCase()+a.toLowerCase(),c=this.options[c];this.element.trigger(e,b);return c&&c.apply(this.element,b)},_buildMeasure:function(){var a=this.$input;return d('<measure class="mf_measure" />').css({fontFamily:a.css("fontFamily"),
fontSize:a.css("fontSize"),fontWeight:a.css("fontWeight"),left:-9999,letterSpacing:a.css("letterSpacing"),position:"absolute",top:-9999,whiteSpace:"nowrap",width:"auto"})},_bindMarcoPolo:function(a){var b=this,c=b.$input,e=b.options;typeof a==="undefined"&&(a=d.extend({},e.marcoPolo,b._marcoPoloOptions()));c.marcoPolo(a);c.marcoPolo("list").bind("mousedown.manifest",function(){if(!e.required)b.mpMousedown=!0});return b},_bindInput:function(){var a=this,b=a.$input,c=a.options;b.bind("keydown.manifest",
function(c){a._resizeInput();if(!b.val())switch(c.which){case a.keys.BACKSPACE:case a.keys.DELETE:c=a._selected();c.length?a.remove(c):a._selectPrev();break;case a.keys.LEFT:a._selectPrev();break;case a.keys.RIGHT:a._selectNext();break;default:a._removeSelected()}}).bind("keypress.manifest",function(d){!c.required&&d.which===c.separator.charCodeAt()&&(d.preventDefault(),b.val()&&a._add(b.val(),null))}).bind("keyup.manifest",function(){a._resizeInput()}).bind("blur.manifest",function(){setTimeout(function(){a.mousedown||
a._removeSelected();!a.mpMousedown&&!c.required&&b.val()&&a._add(b.val(),null)},1)});return a},_bindList:function(){var a=this;a.$list.delegate("li","mouseover",function(){a._addHighlight(d(this))}).delegate("li","mouseout",function(){a._removeHighlight(d(this))}).delegate("li","mousedown",function(){a.mousedown=!0}).delegate("li","click",function(){a._toggleSelect(d(this))}).delegate("a.mf_remove","click",function(b){a.remove(d(this).closest("li"));b.preventDefault()});return a},_bindDocument:function(){var a=
this,b=a.$input;d(document).bind("mouseup.manifest",function(c){if(a.mousedown&&!d(c.target).is("li.mf_item, li.mf_item *"))a.mousedown=!1,a._removeSelected();if(a.mpMousedown&&!a.options.required)a.mpMousedown=!1,b.val()&&a._add(b.val(),null)});return a},_bindContainer:function(){var a=this;a.$container.bind("click.manifest",function(){a.$input.focus()});return a},_highlighted:function(){return this.$list.children("li.mf_highlighted")},_addHighlight:function(a){if(!a.length)return this;this._removeHighlighted();
a.addClass("mf_highlighted");this._trigger("highlight",[a.data("marcoPolo"),a]);return this},_removeHighlight:function(a){if(!a.length)return this;a.removeClass("mf_highlighted");this._trigger("highlightRemove",[a.data("marcoPolo"),a]);return this},_removeHighlighted:function(){return this._removeHighlight(this._highlighted())},_selected:function(){return this.$list.children("li.mf_selected")},_addSelect:function(a){if(!a.length)return this;this._removeSelected();a.addClass("mf_selected");this._trigger("select",
[a.data("marcoPolo"),a]);return this},_removeSelect:function(a){if(!a.length)return this;a.removeClass("mf_selected");this._trigger("selectRemove",[a.data("marcoPolo"),a]);return this},_removeSelected:function(){return this._removeSelect(this._selected())},_toggleSelect:function(a){return a.hasClass("mf_selected")?this._removeSelect(a):this._addSelect(a)},_selectPrev:function(){var a=this._selected(),b=d(),b=a.length?a.prev():this.$list.children(":last");b.length&&this._addSelect(b);return this},
_selectNext:function(){var a=this._selected(),b=a.next();return b.length?this._addSelect(b):this._removeSelect(a)},_resizeInput:function(){var a=this.$input,b=this.$measure,c=a.val().replace(/&/g,"&amp;").replace(/\s/g,"&nbsp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");b.html(c+"---");a.width(b.width());return this}})})(jQuery);
