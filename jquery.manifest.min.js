...
onRequestAfter:function(){a.$container.parent().removeClass("mf_busy");b.marcoPolo.onRequestAfter&&b.marcoPolo.onRequestAfter.call(this)},onRequestBefore:function(){a.$container.parent().addClass("mf_busy");b.marcoPolo.onRequestBefore&&b.marcoPolo.onRequestBefore.call(this)},onSelect:function(d,c){b.marcoPolo.onSelect&&b.marcoPolo.onSelect.call(this,d,c);a.add(d,c,!0,!0)},required:b.required}},keys:{BACKSPACE:8,DELETE:46,ENTER:13,LEFT:37,RIGHT:39},_create:function(){var a=this.options;this.$input=
...
arguments)},_bindMarcoPolo:function(a){var b=this,d=b.$input,g=b.options;a===m&&(a=c.extend({},g.marcoPolo,b._marcoPoloOptions()));d.marcoPolo(a);d.marcoPolo("list").bind("mousedown.manifest",function(){b.mpMousedown=!0});return b},_bindInput:function(){var a=this,b=a.$input,c=a.options;b.bind("keydown.manifest",function(c){a._resizeInput();c.which===a.keys.ENTER&&c.preventDefault();if(!b.val())switch(c.which){case a.keys.BACKSPACE:case a.keys.DELETE:c=a._selected();c.length?a.remove(c):a._selectPrev();
break;case a.keys.LEFT:a._selectPrev();break;case a.keys.RIGHT:a._selectNext();break;default:a._removeSelected()}}).bind("keypress.manifest",function(g){!c.required&&g.which===c.separator.charCodeAt()&&(g.preventDefault(),b.val()&&a.add(b.val(),null,!0,!0))}).bind("keyup.manifest",function(){a._resizeInput()}).bind("blur.manifest",function(){setTimeout(function(){a.mousedown||a._removeSelected();a.mpMousedown||(c.marcoPolo&&c.required?a._resizeInput():b.val()&&a.add(b.val(),null,!0,!0))},1)});return a},
_bindList:function(){var a=this;a.$list.delegate("li","mouseover",function(){a._addHighlight(c(this))}).delegate("li","mouseout",function(){a._removeHighlight(c(this))}).delegate("li","mousedown",function(){a.mousedown=!0}).delegate("li","click",function(){a._toggleSelect(c(this))}).delegate("a.mf_remove","click",function(b){a.remove(c(this).closest("li"));b.preventDefault()});return a},_bindContainer:function(){var a=this;a.$container.bind("click.manifest",function(){a.$input.focus()});return a},
_bindDocument:function(){var a=this,b=a.$input;c(document).bind("mouseup.manifest",function(d){if(a.mousedown)a.mousedown=!1,c(d.target).is("li.mf_item, li.mf_item *")||a._removeSelected();if(a.mpMousedown)a.mpMousedown=!1,a.options.required?a._resizeInput():b.val()&&a.add(b.val(),null,!0,!0)});return a},container:function(){return this.$container},list:function(){return this.$list},add:function(a,b,d,g){for(var k=this.$input,h=this.options,a=c.isArray(a)?a:[a],e,f=c(),i=c(),j=c(),i=!0,l=0;l<a.length;l++)if(e=
a[l],"string"===typeof e&&(e=c.trim(e)),e&&(!c.isPlainObject(e)||!c.isEmptyObject(e)))f=c('<li class="mf_item" />'),i=c('<a href="#" class="mf_remove" title="Remove" />'),j=c('<input type="hidden" class="mf_value" />'),f.data("manifest",e),f.html(h.formatDisplay.call(k,e,f,b)),i.html(h.formatRemove.call(k,i,f)),h.valuesName?j.attr("name",h.valuesName+"[]"):j.attr("name",k.attr("name")+"_values[]"),j.val(h.formatValue.call(k,e,j,f,b)),f.append(i,j),i=this._trigger("add",[e,f]),!1!==i&&(f.appendTo(this.$list),
(g||g===m)&&this._trigger("change",["add",e,f]));d&&this._clearInputValue()},_addInputValues:function(){var a=this.$input,b=a.data("values"),a=a.val(),d=[];b?d=c.isArray(b)?b:[b]:a&&(d=a.split(this.options.separator),d=c.map(d,c.trim));d.length&&this.add(d,null,!0,!1);return this},remove:function(a){var b=this,d=c(),d=a instanceof jQuery?a:b.$list.children(a);d.each(function(){var a=c(this),d=a.data("manifest"),h=!0,h=b._trigger("remove",[d,a]);!1!==h&&(a.remove(),b._trigger("change",["remove",d,
a]))})},values:function(){var a=[];this.$list.find("input:hidden.mf_value").each(function(){a.push(c(this).val())});return a},destroy:function(){var a=this.values().join(this.options.separator+" ");this.options.marcoPolo&&this.$input.marcoPolo("destroy");this.$list.remove();this.$measure.remove();this.$input.unwrap().removeClass("mf_input").width(this.originalWidth).val(a);c(document).unbind(".manifest");c.Widget.prototype.destroy.apply(this,arguments)},_styleMeasure:function(){var a=this.$input;
this.$measure.css({fontFamily:a.css("font-family"),fontSize:a.css("font-size"),fontStyle:a.css("font-style"),fontVariant:a.css("font-variant"),fontWeight:a.css("font-weight"),left:-9999,letterSpacing:a.css("letter-spacing"),position:"absolute",textTransform:a.css("text-transform"),top:-9999,whiteSpace:"nowrap",width:"auto",wordSpacing:a.css("word-spacing")});return this},_measureText:function(a){var b=this.$measure,a=a.replace(/&/g,"&amp;").replace(/\s/g,"&nbsp;").replace(/</g,"&lt;").replace(/>/g,
"&gt;");b.html(a);return b.width()},_maxInputWidth:function(){var a=this.$input;return this.$container.width()-(a.outerWidth(!0)-a.width())},_resizeInput:function(){var a=this.$input,b;b=this._measureText(a.val()+"---");a.width(Math.min(b,this._maxInputWidth()));return this},_clearInputValue:function(){var a=this.$input;this.options.marcoPolo?a.marcoPolo("change",""):a.val("");this._resizeInput();return this},_highlighted:function(){return this.$list.children("li.mf_highlighted")},_addHighlight:function(a){if(!a.length)return this;
this._removeHighlighted();a.addClass("mf_highlighted");this._trigger("highlight",[a.data("marcoPolo"),a]);return this},_removeHighlight:function(a){if(!a.length)return this;a.removeClass("mf_highlighted");this._trigger("highlightRemove",[a.data("marcoPolo"),a]);return this},_removeHighlighted:function(){return this._removeHighlight(this._highlighted())},_selected:function(){return this.$list.children("li.mf_selected")},_addSelect:function(a){if(!a.length)return this;this._removeSelected();a.addClass("mf_selected");
this._trigger("select",[a.data("marcoPolo"),a]);return this},_removeSelect:function(a){if(!a.length)return this;a.removeClass("mf_selected");this._trigger("selectRemove",[a.data("marcoPolo"),a]);return this},_removeSelected:function(){return this._removeSelect(this._selected())},_toggleSelect:function(a){return a.hasClass("mf_selected")?this._removeSelect(a):this._addSelect(a)},_selectPrev:function(){var a=this._selected(),b=c(),b=a.length?a.prev():this.$list.children(":last");b.length&&this._addSelect(b);
return this},_selectNext:function(){var a=this._selected(),b=a.next();return b.length?this._addSelect(b):this._removeSelect(a)},_trigger:function(a,b){var c="on"+a.charAt(0).toUpperCase()+a.slice(1),g=this.widgetEventPrefix.toLowerCase()+a.toLowerCase(),c=this.options[c];this.element.trigger(g,b);return c&&c.apply(this.element,b)}})})(jQuery);
