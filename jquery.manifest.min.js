...
false,a.options.required?a._resizeInput():b.val()&&a.add(b.val(),null,true)});return a},container:function(){return this.$container},list:function(){return this.$list},add:function(a,b,c){var g=this.$input,i=this.options,a=d.isArray(a)?a:[a],f,e=d(),j=d(),h=d();f=true;for(var k=0;k<a.length;k++)f=a[k],e=d('<li class="mf_item" />'),j=d('<a href="#" class="mf_remove" title="Remove" />'),h=d('<input type="hidden" class="mf_value" />'),e.data("manifest",f),e.html(i.formatDisplay.call(g,f,e,b)),j.html(i.formatRemove.call(g,
j,e)),i.valuesName?h.attr("name",i.valuesName+"[]"):h.attr("name",g.attr("name")+"_values[]"),h.val(i.formatValue.call(g,f,h,e,b)),e.append(j,h),f=this._trigger("add",[f,e]),f!==false&&e.appendTo(this.$list);c&&this._clearInputValue()},_addInputValues:function(){var a=this.$input,b=a.data("values"),a=a.val(),c=[];b?c=d.isArray(b)?b:[b]:a&&(c=a.split(this.options.separator),c=d.map(c,d.trim));c.length&&this.add(c,null,true);return this},remove:function(a){var b=this,c=d(),c=a instanceof jQuery?a:b.$list.children(a);
c.each(function(){var a=d(this),c=true,c=b._trigger("remove",[a.data("manifest"),a]);c!==false&&a.remove()})},values:function(){var a=[];this.$list.find("input:hidden.mf_value").each(function(){a.push(d(this).val())});return a},destroy:function(){var a=this.values().join(this.options.separator+" ");this.options.marcoPolo&&this.$input.marcoPolo("destroy");this.$list.remove();this.$measure.remove();this.$input.unwrap().removeClass("mf_input").width(this.originalWidth).val(a);d(document).unbind(".manifest");
d.Widget.prototype.destroy.apply(this,arguments)},_styleMeasure:function(){var a=this.$input;this.$measure.css({fontFamily:a.css("font-family"),fontSize:a.css("font-size"),fontStyle:a.css("font-style"),fontVariant:a.css("font-variant"),fontWeight:a.css("font-weight"),left:-9999,letterSpacing:a.css("letter-spacing"),position:"absolute",textTransform:a.css("text-transform"),top:-9999,whiteSpace:"nowrap",width:"auto",wordSpacing:a.css("word-spacing")});return this},_measureText:function(a){var b=this.$measure,
a=a.replace(/&/g,"&amp;").replace(/\s/g,"&nbsp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");b.html(a);return b.width()},_maxInputWidth:function(){var a=this.$input;return this.$container.width()-(a.outerWidth(true)-a.width())},_resizeInput:function(){var a=this.$input,b;b=this._measureText(a.val()+"---");a.width(Math.min(b,this._maxInputWidth()));return this},_clearInputValue:function(){var a=this.$input;this.options.marcoPolo?a.marcoPolo("change",""):a.val("");this._resizeInput();return this},_highlighted:function(){return this.$list.children("li.mf_highlighted")},
_addHighlight:function(a){if(!a.length)return this;this._removeHighlighted();a.addClass("mf_highlighted");this._trigger("highlight",[a.data("marcoPolo"),a]);return this},_removeHighlight:function(a){if(!a.length)return this;a.removeClass("mf_highlighted");this._trigger("highlightRemove",[a.data("marcoPolo"),a]);return this},_removeHighlighted:function(){return this._removeHighlight(this._highlighted())},_selected:function(){return this.$list.children("li.mf_selected")},_addSelect:function(a){if(!a.length)return this;
this._removeSelected();a.addClass("mf_selected");this._trigger("select",[a.data("marcoPolo"),a]);return this},_removeSelect:function(a){if(!a.length)return this;a.removeClass("mf_selected");this._trigger("selectRemove",[a.data("marcoPolo"),a]);return this},_removeSelected:function(){return this._removeSelect(this._selected())},_toggleSelect:function(a){return a.hasClass("mf_selected")?this._removeSelect(a):this._addSelect(a)},_selectPrev:function(){var a=this._selected(),b=d(),b=a.length?a.prev():
this.$list.children(":last");b.length&&this._addSelect(b);return this},_selectNext:function(){var a=this._selected(),b=a.next();return b.length?this._addSelect(b):this._removeSelect(a)},_trigger:function(a,b){var c="on"+a.charAt(0).toUpperCase()+a.slice(1),d=this.widgetEventPrefix.toLowerCase()+a.toLowerCase(),c=this.options[c];this.element.trigger(d,b);return c&&c.apply(this.element,b)}})})(jQuery);
