...
this.element.addClass("mf_input");this.$container=c('<div class="mf_container" />');this.$list=c('<ol class="mf_list" />');this.$measure=c('<span class="mf_measure" />');this.mpMousedown=this.mousedown=!1;this.originalWidth=this.$input.css("width");a.marcoPolo&&(b=this.$input.val(),this.$input.val(""),this._bindMarcoPolo(),this.$input.val(b));this._bindInput()._bindList()._bindContainer()._bindDocument();this.$input.wrap(this.$container).before(this.$list).after(this.$measure);this.$container=this.$input.parent();
a.values&&this.add(a.values,null,!1,!1);this._addInputValues()._styleMeasure()._resizeInput()},_setOption:function(a,b){var d=this.$input;switch(a){case "marcoPolo":this.options.marcoPolo?b?d.marcoPolo("option",c.extend({},b,this._marcoPoloOptions())):d.marcoPolo("destroy"):b&&(this._bindMarcoPolo(c.extend({},b,this._marcoPoloOptions())),d.marcoPolo("list").insertAfter(d.parent()));break;case "required":this.options.marcoPolo&&d.marcoPolo("option","required",b);break;case "values":this.add(b,null,
!1,!0);break;case "valuesName":this.$list.find("input:hidden.mf_value").attr("name",b+"[]")}c.Widget.prototype._setOption.apply(this,arguments)},_bindMarcoPolo:function(a){var b=this,d=b.$input,e=b.options;a===m&&(a=c.extend({},e.marcoPolo,b._marcoPoloOptions()));d.marcoPolo(a);d.marcoPolo("list").bind("mousedown.manifest",function(){b.mpMousedown=!0});return b},_bindInput:function(){var a=this,b=a.$input,c=a.options;b.bind("keydown.manifest",function(c){a._resizeInput();c.which===a.keys.ENTER&&c.preventDefault();
if(!b.val())switch(c.which){case a.keys.BACKSPACE:case a.keys.DELETE:c=a._selected();c.length?a.remove(c):a._selectPrev();break;case a.keys.LEFT:a._selectPrev();break;case a.keys.RIGHT:a._selectNext();break;default:a._removeSelected()}}).bind("keypress.manifest",function(e){!c.required&&a._isSeparator(e.which)&&(e.preventDefault(),b.val()&&a.add(b.val(),null,!0,!0))}).bind("keyup.manifest",function(){a._resizeInput()}).bind("blur.manifest",function(){setTimeout(function(){a.mousedown||a._removeSelected();
a.mpMousedown||(c.marcoPolo&&c.required?a._resizeInput():b.val()&&a.add(b.val(),null,!0,!0))},1)});return a},_bindList:function(){var a=this;a.$list.delegate("li","mouseover",function(){a._addHighlight(c(this))}).delegate("li","mouseout",function(){a._removeHighlight(c(this))}).delegate("li","mousedown",function(){a.mousedown=!0}).delegate("li","click",function(){a._toggleSelect(c(this))}).delegate("a.mf_remove","click",function(b){a.remove(c(this).closest("li"));b.preventDefault()});return a},_bindContainer:function(){var a=
this;a.$container.bind("click.manifest",function(){a.$input.focus()});return a},_bindDocument:function(){var a=this,b=a.$input;c(document).bind("mouseup.manifest",function(d){if(a.mousedown)a.mousedown=!1,c(d.target).is("li.mf_item, li.mf_item *")||a._removeSelected();if(a.mpMousedown)a.mpMousedown=!1,a.options.required?a._resizeInput():b.val()&&a.add(b.val(),null,!0,!0)});return a},container:function(){return this.$container},list:function(){return this.$list},add:function(a,b,d,e){for(var k=this.$input,
h=this.options,a=c.isArray(a)?a:[a],f,g=c(),i=c(),j=c(),i=!0,l=0;l<a.length;l++)if(f=a[l],"string"===typeof f&&(f=c.trim(f)),f&&(!c.isPlainObject(f)||!c.isEmptyObject(f)))g=c('<li class="mf_item" />'),i=c('<a href="#" class="mf_remove" title="Remove" />'),j=c('<input type="hidden" class="mf_value" />'),g.data("manifest",f),g.html(h.formatDisplay.call(k,f,g,b)),i.html(h.formatRemove.call(k,i,g)),h.valuesName?j.attr("name",h.valuesName+"[]"):j.attr("name",k.attr("name")+"_values[]"),j.val(h.formatValue.call(k,
f,j,g,b)),g.append(i,j),i=this._trigger("add",[f,g]),!1!==i&&(g.appendTo(this.$list),(e||e===m)&&this._trigger("change",["add",f,g]));d&&this._clearInputValue()},_addInputValues:function(){var a=this.$input,b=a.data("values"),a=a.val(),d=[];b?d=c.isArray(b)?b:[b]:a&&(d=a.split(this._separator()),d=c.map(d,c.trim));d.length&&this.add(d,null,!0,!1);return this},remove:function(a){var b=this,d=c(),d=a instanceof jQuery?a:b.$list.children(a);d.each(function(){var a=c(this),d=a.data("manifest"),h=!0,h=
b._trigger("remove",[d,a]);!1!==h&&(a.remove(),b._trigger("change",["remove",d,a]))})},values:function(){var a=[];this.$list.find("input:hidden.mf_value").each(function(){a.push(c(this).val())});return a},destroy:function(){var a=this.values().join(this._separator()+" ");this.options.marcoPolo&&this.$input.marcoPolo("destroy");this.$list.remove();this.$measure.remove();this.$input.unwrap().removeClass("mf_input").width(this.originalWidth).val(a);c(document).unbind(".manifest");c.Widget.prototype.destroy.apply(this,
arguments)},_styleMeasure:function(){var a=this.$input;this.$measure.css({fontFamily:a.css("font-family"),fontSize:a.css("font-size"),fontStyle:a.css("font-style"),fontVariant:a.css("font-variant"),fontWeight:a.css("font-weight"),left:-9999,letterSpacing:a.css("letter-spacing"),position:"absolute",textTransform:a.css("text-transform"),top:-9999,whiteSpace:"nowrap",width:"auto",wordSpacing:a.css("word-spacing")});return this},_measureText:function(a){var b=this.$measure,a=a.replace(/&/g,"&amp;").replace(/\s/g,
